...
const guideSteps = [
  ...
  { title: "查看结果", desc: "扫描后可在下方查看每个文件的映射详情，包括本地栏目ID、国网栏目ID和状态（正常/重复）。" },
  { title: "批量新增", desc: "在批量新增区域填写本地栏目ID和国网栏目ID，点击「写入所有文件」即可同步到所有 theme 文件。" },
  { title: "自动备份", desc: "写入前会自动创建备份，备份路径显示在操作结果中，可通过「打开」按钮查看。" },
